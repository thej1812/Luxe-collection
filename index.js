...
// Character names for better display
var characterNames = [
  "Hank", "Emmy", "Shirmond", "Sara", 
  "Patty", "Jessie", "Kim", "Mindy", 
  "Zak", "Bear"
];
...
function setActive(index) {
  ...
  if (nameDisplay) {
    nameDisplay.textContent = characterNames[index];
  }
}
...
// Function to choose character and redirect to game page
function chooseCharacter() {
  // Save selected character to localStorage
  localStorage.setItem('selectedCharacterIndex', activeIndex);
  localStorage.setItem('selectedCharacterSprite', spritesheets[activeIndex]);
  localStorage.setItem('selectedCharacterName', characterNames[activeIndex]);
